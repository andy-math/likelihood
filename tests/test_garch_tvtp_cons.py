...
def run_once(coeff: ndarray, n: int, seed: int = 0) -> None:
    ...
    beta0 = numpy.array([1.0, 1.0, 0.011, 0.022, 0.078, 0.89])
...
class Test_1:
    def test_1(_) -> None:
        run_once(numpy.array([1.0, 1.0, 0.011, 0.022, 0.078, 0.89]), 1000)
